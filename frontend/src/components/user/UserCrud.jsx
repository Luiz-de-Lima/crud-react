            ...
            <div className="form">
                <div className="row">
                    <div className="col-12 col-md-6">
                        <div className="form">
                            <label>Nome</label>
                            <input type="text" name="name" id="" className="form-control" value={this.state.user.name} onChange={e => this.UpdateField(e)} placeholder="Digite o nome" />
                        </div>
                    </div>
                    <div className="col-12 col-md-6">
                ...
                <div className="row">
                    <div className="col-12 d-flex justify-content-end">
                        ...
                        <button className="btn btn-danger ml-2"> {e => this.clear(e)}
                            Cancelar
                        </button>
                    </div>
                </div>
